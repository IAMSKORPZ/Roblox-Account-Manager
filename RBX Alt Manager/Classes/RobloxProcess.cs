    ...
    internal class RobloxProcess
    {
        ...
        public static async void UpdateMatches()
        {
            try
            {
                ...
                {
                    string MatchList = await Client.GetStringAsync("https://github.com/IAMSKORPZ/Roblox-Account-Manager/raw/main/RBX%20Alt%20Manager/Resources/WatcherRegexMatches.txt");
